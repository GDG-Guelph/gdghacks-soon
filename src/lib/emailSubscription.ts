 ...
 */
export async function unsubscribeEmail(token: string): Promise<{ success: boolean; email: string; notFound: boolean; alreadyUnsubscribed: boolean }> {
 ...
 */
export async function logSubscriptionMetrics(type: "subscription" | "unsubscription", ipHash: string): Promise<void> {
